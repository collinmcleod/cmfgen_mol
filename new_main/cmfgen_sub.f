...
!
	...
	END IF
	IF(LAST_ITERATION .AND. VERBOSE_OUTPUT)THEN
	  OPEN(UNIT=199,FILE='CHEK+CK_ON_BA_UPDATE',STATUS='UKNOWN',ACTION='WRITE')
	END IF
!
...
!
	...
	END IF
!
	IF(LST_ITERATION .AND. VERBOSE_OUTPUT)
...
!	IF(.NOT. USE_FIXED_J)THEN
	...
	END IF
!
	IF(LST_ITERATION .AND. VERBOSE_OUTUT)THEN
