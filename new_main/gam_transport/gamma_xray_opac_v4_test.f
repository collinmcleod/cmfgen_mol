...
!
	REAL(10) :: CHI(ND)
	REAL(10) :: E_SCAT_CHI(ND)
	REAL(10) :: ED_TOT(ND)
	REAL(10) :: PHOTABS(ND)
	REAL(10) :: T1,T2,T3,T4
	REAL(10) :: NU 		! frequency in Hz 
	REAL(10) :: XCROSS_V2
	REAL(10) :: CROSS_KN
	REAL(10) :: COMPTON_SIG
	REAL(10) :: EGAM
	REAL(10) :: XRAY
	REAL(10), PARAMETER :: PLANCK = 4.135668D-21 ! MeV*s
	REAL(10), PARAMETER :: SIGT = 6.6524587D-25 ! cm^2
	REAL(10), PARAMETER :: ALPHA = 7.297355257D-3 ! units in cgs
	REAL(10), PARAMETER :: MeC2 = 0.5109989 ! MeV
	EXTERNAL XCROSS_V2
	EXTERNAL CROSS_KN
...
!
	REAL(10) :: NU
	REAL(10) :: CROSS_KN 	! will return in units of cm^2
!
	REAL(10) :: EPSI
	REAL(10) :: X
	REAL(10) :: PI
...
!
	...
	REAL(10), PARAMETER :: R_C=2.42630694715D-10 ! h/(m_e*c) in units of cm
	REAL(10), PARAMETER :: H = 4.135668E-021	! Units of MeV*s 
	REAL(10), PARAMETER :: M_E = 0.5109989	! Units of MeV
	REAL(10), PARAMETER :: ALPHA=0.007297355257 	! Fine structure constant
!
	PI=ACOS(-ONE)
