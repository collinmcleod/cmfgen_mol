...
!
! Set default relaxation parameter.
!
	DO I=1,ND
	  RELAX_PARAM(I)=1.0D0
	END DO
!
! ADJUST_CORRECTIONS should contain a list of depths with the relaxation parameter.
! 0 < relaxation parameter < 2.
! A relxation parameter < 1 may halp oscilatiry cases converge.
!
