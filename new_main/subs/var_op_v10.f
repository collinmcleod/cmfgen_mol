...
C
	REAL(10), TARGET :: VCHI(NT,ND)		!VCHI(I,K)=dCHI(K)/dN(I,K)
	REAL(10), TARGET :: VETA(NT,ND)		!VETA(I,K)=dETA(K)/dN(I,K)
	REAL(10), TARGET :: VCHI_NOT_IMP(NT,ND)
	REAL(10), TARGET :: VETA_NOT_IMP(NT,ND)
C
	REAL(10) HN_S(N_S,ND)
	REAL(10) HNST_S(N_S,ND)
	REAL(10) LOG_HNST_S(N_S,ND)
...
C Local variables.
C
	REAL(10), POINTER :: PCHI(:,:)
	REAL(10), POINTER :: PETA(:,:)
C
	REAL(10) GFF_VAL(ND)		!Used as work vector
	REAL(10) LOG_DI_RAT(ND)		!Used as work vector
...
C
	...
	REAL(10) SUM_ION; REAL(10) SUM_T1; REAL(10) SUM_T2
	REAL(10) SUM_ION_NOT_IMP; REAL(10) SUM_T1_NOT_IMP; REAL(10) SUM_T2_NOT_IMP
