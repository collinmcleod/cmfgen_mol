...
!
	INTEGER N_CLUMP_PAR
	REAL(10) CLUMP_PAR(N_CLUMP_PAR)
	CHARACTER(LEN=*) CLUMP_LAW
!
	REAL(10) OLD_CLUMP_FAC(ND)
	REAL(10) CURRENT_CLUMP_VALUE
	REAL(10) NEW_CLUMP_VALUE
	REAL(10) DESIRED_CLUMP_VALUE
	REAL(10) CLUMP_REV_FACTOR
...
!
	...
	REAL(10) V_VEC(1),E1,E2
	REAL(10) NEW_CLUMP_VALUE(1)
...
!
	...
	REAL(10), ALLOCATABLE :: DXzV(:)
	REAL(10), ALLOCATABLE :: XZV_F(:,:)
!
...
!
	...
	REAL(10), ALLOCATABLE :: V_SN(:)
	REAL(10), ALLOCATABLE :: CLUMP_FAC(:)
	REAL(10), ALLOCATABLE :: T_SN(:)
!
	INTEGER ND_SN
	INTEGER I
	INTEGER, PARAMETER :: IONE=1
