...
!
	INTEGER ND
	REAL(10) MAX_RATIO(NUM_IONS)
!
	REAL(10), PARAMETER ::  LOW_LIMIT=1.0D-10
	REAL(10), PARAMETER :: HIGH_LIMIT=1.0D-04
	REAL(10) T1,T2
	REAL(10) HDKT_EV
	REAL(10) T_VAL
	REAL(10) ED_VAL
	REAL(10) ION_FRAC
	REAL(10) INTERNAL_ENERGY
	REAL(10) EXTRA_INT_EN
	REAL(10) ATOM_ION_DENSITY
	INTEGER ISPEC
	INTEGER J,K
	INTEGER ID
	INTEGER DPTH_INDX
