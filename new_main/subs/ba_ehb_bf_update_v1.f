...
!
	...
	REAL*8, ALLOCATABLE :: VJ_R_EHB(:,:,:)
	REAL*8, ALLOCATABLE :: VJ_P_EHB(:,:,:)
	REAL*8, ALLOCATABLE :: RJ_SUM(:)
	REAL*8, ALLOCATABLE :: RJ_SUM_EHB(:)
	SAVE
!
...
!
	...
	EXTERNAL ERROR_LU
!
	REAL*8 PLANCKS_CONSTANT,PC
	EXTERNAL PLANCKS_CONSTANT
	REAL*8 T1,T2
	REAL*8 RJ_RAD(ND)
	REAL*8 LOC_QFV_P,LOC_QFV_R
	REAL*8 LOC_QFV_P_EHB,LOC_QFV_R_EHB
