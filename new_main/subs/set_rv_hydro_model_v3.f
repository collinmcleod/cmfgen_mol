...
!
	...
	REAL(10), ALLOCATABLE :: KAPPA_HYDRO(:)
	REAL(10), ALLOCATABLE :: TAU_HYDRO(:)
!
	REAL(10), ALLOCATABLE :: OLD_R(:)
	REAL(10), ALLOCATABLE :: LOG_OLD_R(:)
...
!
	REAL(10), PARAMETER :: IB_FAC=2.5D0
	REAL(10), PARAMETER :: OB_FAC=1.5D0
!
	INTEGER ND_TMP
	INTEGER NX
	INTEGER NS
