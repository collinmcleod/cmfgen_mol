...
!
	REAL(10), ALLOCATABLE :: R_HYDRO(:)
	REAL(10), ALLOCATABLE :: LOG_R_HYDRO(:)
	REAL(10), ALLOCATABLE :: V_HYDRO(:)
	REAL(10), ALLOCATABLE :: SIGMA_HYDRO(:)
	REAL(10), ALLOCATABLE :: T_HYDRO(:)
	REAL(10), ALLOCATABLE :: DENSITY_HYDRO(:)
	REAL(10), ALLOCATABLE :: ATOM_DEN_HYDRO(:)
	REAL(10), ALLOCATABLE :: ELEC_DEN_HYDRO(:)
	REAL(10), ALLOCATABLE :: CLUMP_FAC_HYDRO(:)
	REAL(10), ALLOCATABLE :: POP_HYDRO(:,:)
	REAL(10), ALLOCATABLE :: ISO_HYDRO(:,:)
	REAL(10), ALLOCATABLE :: WRK_HYDRO(:)
	INTEGER, ALLOCATABLE :: BARY_HYDRO(:)
	CHARACTER(LEN=10), ALLOCATABLE :: SPEC_HYDRO(:)
	CHARACTER(LEN=10), ALLOCATABLE :: ISO_SPEC_HYDRO(:)
!
	REAL(10) MASS_SPECIES(100)
	REAL(10) WRK(ND)
	REAL(10) LOG_R(ND)
	REAL(10) DELTA_T_SECS
	REAL(10) OLD_SN_AGE_DAYS
	REAL(10) DEN_SCL_FAC
	REAL(10) T1,T2
	REAL(10) MF_IB,MF_OB
	REAL(10) ISO_MF_IB,ISO_MF_OB
!
	INTEGER NX
	INTEGER NSP
	INTEGER NISO
