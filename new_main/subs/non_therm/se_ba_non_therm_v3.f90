...
!
	...
	REAL(10) RADIOACTIVE_DECAY_ENERGY_eV(ND)
	REAL(10) LOCAL_ION_HEATING(ND)
	REAL(10) LOCAL_EXC_HEATING(ND)
	REAL(10) WRK_EDEP(ND)
	REAL(10) WRK_EDEP_eV(ND)
	LOGICAL COMPUTE_BA
!
	REAL(10) MOD_YE(NKT,ND)
	REAL(10) PI
...
!
	...
	REAL(10), PARAMETER :: Hz_to_eV=13.60D0/3.2897D0
	REAL(10), PARAMETER :: Hz_to_erg=6.6261965D-12
!
