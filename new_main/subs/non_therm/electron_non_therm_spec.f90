...
!	INTEGER NUM_IONS
	INTEGER ND
!
	REAL(10), SAVE, ALLOCATABLE :: LELEC(:)
	REAL(10), SAVE, ALLOCATABLE :: SOURCE(:)
	REAL(10), SAVE, ALLOCATABLE :: RHS(:)
	REAL(10), SAVE, ALLOCATABLE :: DETAI_DE(:)
	REAL(10), SAVE, ALLOCATABLE :: MAT(:,:)
	REAL(10), SAVE, ALLOCATABLE :: Qnn(:)
	REAL(10), SAVE, ALLOCATABLE :: Qnn_TMP(:)
	REAL(10), SAVE, ALLOCATABLE :: POP_VEC(:)
!
...
!
	REAL(10) ION_SUM(NUM_IONS)
	REAL(10) SPEC_SUM(NUM_IONS)
...
!
	...
	REAL(10) NATOM
	REAL(10) QSUM
	REAL(10) SCALER_SPEC_SUM
	REAL(10) SCALER_ION_SUM
	REAL(10) dXKT_MIN
!
	INTEGER GET_INDX_DP
	REAL(10) INTSIGC
...
!
	REAL(10), PARAMETER :: Hz_to_eV=13.60569253D0/3.289841960D0
	REAL(10), PARAMETER :: DELTA_ENR_SOURCE=30.0D0
