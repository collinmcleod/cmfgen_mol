	...
	IMPLICIT NONE
	REAL(10), ALLOCATABLE :: GRAD_STORE(:)
	REAL(10), ALLOCATABLE :: GRAD_RD(:)
	REAL(10), ALLOCATABLE :: GELEC_RD(:)
	REAL(10), ALLOCATABLE :: VdVdR_RD(:)
!
	REAL(10), ALLOCATABLE :: R_OLD(:)
	REAL(10), ALLOCATABLE :: V_OLD(:)
	REAL(10), ALLOCATABLE :: SIGMA_OLD(:)
	REAL(10), ALLOCATABLE :: GRAD_OLD(:)
	REAL(10), ALLOCATABLE :: GELEC_OLD(:)
	REAL(10), ALLOCATABLE :: VdVdR_OLD(:)
	REAL(10), ALLOCATABLE :: CLUMP_FAC_OLD(:)
!
	REAL(10), ALLOCATABLE :: RHAT(:)
	REAL(10), ALLOCATABLE :: CLUMP_FAC(:)
	REAL(10), ALLOCATABLE :: V_NEW(:)
	REAL(10), ALLOCATABLE :: SIGMA_NEW(:)
	REAL(10), ALLOCATABLE :: GELEC(:)
	REAL(10), ALLOCATABLE :: GRAD(:)
	REAL(10), ALLOCATABLE :: GRAD_MIN(:)
	REAL(10), ALLOCATABLE :: dFdR(:)
	REAL(10), ALLOCATABLE :: F_CORR(:)
...
!
	...
	REAL(10) R_RD(ND_RD)
	REAL(10) V_RD(ND_RD)
	REAL(10) SIGMA_RD(ND_RD)
	REAL(10) CLUMP_FAC_RD(ND_RD)
...
!
	...
	REAL(10) VSOUND
	REAL(10) RSOUND
	REAL(10) RX		!Start radius for integration
	REAL(10) VX 		!Start velocity for integration
!
	REAL(10) LAMBERT_WM_FUN
...
!
	...
	REAL(10) LNZ
	REAL(10) T1,T2
	REAL(10) ERROR, ALLOWED_CHANGE_IN_GRAD
	INTEGER I,J,K,IT
	INTEGER IOS
	INTEGER NUM_ITS
	INTEGER MAX_ITS
