...
!
          INTEGER*4, ALLOCATABLE :: ION_ID_TWO(:)
          INTEGER*4, ALLOCATABLE :: ION_LOW_LEV_TWO(:)
          INTEGER*4, ALLOCATABLE :: ION_UP_LEV_TWO(:)
          INTEGER*4, ALLOCATABLE :: LOW_LEV_TWO(:)
          INTEGER*4, ALLOCATABLE :: UP_LEV_TWO(:)
!	  
