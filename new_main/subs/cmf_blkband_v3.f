...
!	    WRITE(*,*) 'BEFORE DGEEQU:'
!	    WRITE(*,*) 'N: ',N
!	    WRITE(*,*) 'MIN(C_MAT): ',MINVAL(C_MAT)
!	    WRITE(*,*) 'MAX(C_MAT): ',MAXVAL(C_MAT)
!	    WRITE(*,*) 'ROW_SF VALS: ',MINVAL(ROW_SF), MAXVAL(ROW_SF)
!	    WRITE(*,*) 'COL_SF VALS: ',MINVAL(COL_SF), MAXVAL(COL_SF)
!	    WRITE(*,*) 'ROW_CND: ',ROW_CND
!	    WRITE(*,*) 'COL_CND: ',COL_CND
