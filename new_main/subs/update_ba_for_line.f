	...
	IMPLICIT NONE
!
! Altered: 01-Dec-2013 : Added loop variables to OMP private statement.
...
!$OMP PARALLEL DO SCHEDULE(DYNAMIC) PRIVATE(T1,MUL_FAC,OPAC_FAC,EMIS_FAC,STIM_FAC,SIM_INDX,J,K,L,NL,NUP)
	  DO SIM_INDX=1,MAX_SIM
...
!
	      ...
	      END IF
!
!$OMP PARALLEL DO SCHEDULE(DYNAMIC) PRIVATE(T4,K,I,J,JJ,L,NL)
	      DO K=1,ND
