...
!
	...
	1                  DO_THIS_TX_MATRIX,METHOD,ND,NM,NM_KI)
	   ...
	   ELSE IF(USE_DJDT_RTE)THEN
	     CALL VAR_MOM_J_DDT_V3(TA,CHI_CLUMP,CHI_SCAT_CLUMP,ES_COH_VEC,V,R,
	1           TX,TVX,dJ_DIF_d_T,dJ_DIF_d_dTdR,
	...
	1           ND,NM,NM_KI)
	   ELSE
	    CALL VAR_MOM_J_CMF_V11(TA,CHI_CLUMP,CHI_SCAT_CLUMP,
	...
	1           FL,CHECK_H_ON_J,OUT_BC_TYPE,DO_THIS_TX_MATRIX,
