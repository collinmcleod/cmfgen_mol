...
!
	...
	INTEGER*4,   ALLOCATABLE :: VEC_INDX(:)             !NLINE_MAX
	INTEGER*4,   ALLOCATABLE :: VEC_ID(:)               !NLINE_MAX
	INTEGER*4,   ALLOCATABLE :: VEC_NL(:)               !NLINE_MAX
	INTEGER*4,   ALLOCATABLE :: VEC_NUP(:)              !NLINE_MAX
	INTEGER*4,   ALLOCATABLE :: VEC_MNL_F(:)            !NLINE_MAX
	INTEGER*4,   ALLOCATABLE :: VEC_MNUP_F(:)           !NLINE_MAX
	INTEGER*4,   ALLOCATABLE :: VEC_INT_WRK(:)          !NLINE_MAX
...
!
	INTEGER*4, ALLOCATABLE :: LINE_ST_INDX_IN_NU(:)       !NLINE_MAX
	INTEGER*4, ALLOCATABLE :: LINE_END_INDX_IN_NU(:)      !NLINE_MAX
	INTEGER*4, ALLOCATABLE :: LINE_LOC(:)                !NLINE_MAX
!
