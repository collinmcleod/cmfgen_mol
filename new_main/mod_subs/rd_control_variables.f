...
! Altered : 13-Oct-2021 by Collin McLeod : added user variable to include molecular reactions
...
!
	...
	1               'Excludes ions with population NT_OMIT_SCALE_FRAC*(species of ion pop)')
	      ...
	      CALL RD_STORE_LOG(READ_NON_THERM_SPEC,'RD_NT_SP',L_FALSE,'Read non-thermal electron spectrum?')
	    ENDIF
!
