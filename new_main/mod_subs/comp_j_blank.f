...
C
	...
	1            ESECEXT(1:NDEXT)*RJEXT_ES(1:NDEXT)
	     ...
	     CALL MOM_J_CMF_V10(TA,CHIEXT,ESECEXT,VEXT,SIGMAEXT,REXT,
...
C
	...
	1                  FIRST_FREQ,NEW_FREQ,ND)
	     ...
	     ELSE IF(USE_DJDT_RTE)THEN
	       IF(FIRST_FREQ .AND. J_IT_COUNTER .EQ. 0)WRITE(LUER,*)'Calling MOM_J_DDT_V3'
	       CALL MOM_J_DDT_V3(TA,CHI_CLUMP,CHI_SCAT_CLUMP,
	...
	1             INCL_ADVEC_TERMS_IN_TRANS_EQ,INCL_REL_TERMS,FIRST_FREQ,ND)
	     ...
	     ELSE IF(USE_LAM_ES)THEN
	       ...
	       END IF
	     ELSE
	       IF(FIRST_FREQ .AND. J_IT_COUNTER .EQ. 0)WRITE(LUER,*)'Calling MOM_J_CMF_V10'
	       CALL MOM_J_CMF_V10(TA,CHI_CLUMP,CHI_SCAT_CLUMP,V,SIGMA,R,
