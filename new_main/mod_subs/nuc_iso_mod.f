...
!
	...
	REAL(10) :: NUC_ISO_MOD_DELTA_T
!
	REAL(10), POINTER :: RADIOACTIVE_DECAY_ENERGY(:)
	REAL(10), POINTER :: KINETIC_DECAY_ENERGY(:)
!
	TYPE NUC_PARENT_DATA
	  REAL(10), POINTER :: OLD_POP(:)
	  REAL(10), POINTER :: OLD_POP_DECAY(:)
	  INTEGER ISPEC
...
!
	TYPE NUC_ISOTOPE_DATA
	  ...
	  REAL(10), POINTER :: OLD_POP(:)
	  REAL(10), POINTER :: OLD_POP_DECAY(:)
	  REAL(10), POINTER :: NUM_DECAYS(:)	! added to count the amount of gamma rays for decay purposes
	  REAL(10), POINTER :: DECAY_LUM(:) 	! Ergs/cm^3/s
!
	  REAL(10) MASS
...
!
	TYPE NUC_DECAY_DATA
	  REAL(10) HALF_LIFE              !seconds
	  REAL(10) DECAY_CONST		!seconds
	  REAL(10) MASS			!AMU
	  REAL(10) DAUGHTER_MASS
	  REAL(10) ENERGY_PER_DECAY
	  REAL(10) KINETIC_PER_DECAY
