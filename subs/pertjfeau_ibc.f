...
C
	...
	LOGICAL DIFF,THK
	CHARACTER*6 METHOD
	REAL(10) F2DA(ND,ND),FC(ND,ND),FA(ND),DTAU(ND),CHI(ND),R(ND)
	REAL(10) ZETA(ND),THETA(ND),RJ(ND),Q(ND),F(ND)
	REAL(10) dCHIdR(ND),TA(ND),TB(ND),TC(ND)
	REAL(10) DBB,HBC_J,HBC_S,INBC
C
C Functions called.
C
	INTEGER ERROR_LU
