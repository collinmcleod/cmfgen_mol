...
!
	...
	REAL(10), ALLOCATABLE :: G_COEF(:,:)
	REAL(10), ALLOCATABLE :: RSQN_ON_RSQJ_COEF(:,:)
!
...
!
	...
	REAL(10), ALLOCATABLE :: RSQN_ON_RSQJ(:)
	REAL(10), ALLOCATABLE :: F_SAV(:)
	REAL(10), ALLOCATABLE :: G_SAV(:)
	REAL(10), ALLOCATABLE :: RSQN_ON_RSQJ_SAV(:)
!
...
!
	...
	REAL(10), ALLOCATABLE :: EPS(:)
	REAL(10), ALLOCATABLE :: EPS_PREV(:)
!
! Boundary conditions
!
        REAL(10) HBC_PREV
...
!
	...
	REAL(10) V_SM(ND_SM),SIGMA_SM(ND_SM),R_SM(ND_SM)
!
! Radiation field variables. F, G, JNU_PREV, and RSQHNU_PREV must be supplied.
! JNU and RSQHNU recomputed.
!
	REAL(10) F_SM(ND_SM),G_SM(ND_SM),RSQN_ON_RSQJ_SM(ND_SM)
	REAL(10) JNU_SM(ND_SM),RSQHNU_SM(ND_SM)
	REAL(10) VDOP_VEC(ND_SM),VDOP_FRAC
!
