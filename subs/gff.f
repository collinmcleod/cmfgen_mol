...
C
	...
	IMPLICIT NONE
	INTEGER ND
	REAL(10) ZION  		!Ion charge
	REAL(10) RNU		!Frequency in units of 10^15 Hz
	REAL(10) T(ND)		!T in units 10^4 K
	REAL(10) GFF_VAL(ND)	!Returned free-free Gaunt factors.
C
C Important data
C
	INTEGER, PARAMETER :: DP=SELECTED_REAL_KIND(15,3000)
...
C
	INTEGER I,IU,IGB
	REAL(10) U,GB,DU,DGB,A1,A2,LOGT
C
