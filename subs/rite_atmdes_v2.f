...
C
	...
	IMPLICIT NONE
C
C Altered 21-Jun-2022 --- Altered print to avoid writing very large GION
...
C
	...
	CHARACTER STAR*4
C
C Line added to avoid printing errors for carbon monoxide
C which has very large statistical weight
C 
	IF (GIONCI_F .GT. 1.0D4) GIONCI_F=1.0D0
C
	L=ICHRLEN(DESC)
