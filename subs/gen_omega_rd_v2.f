...
! Altered 23-Mar-2022 : Collin altered code due to an issue with reading collision data
!                       for carbon monoxide: increased the size of NL_VEC to deal with
!                       the large number of FULL levels per SUPERlevel
