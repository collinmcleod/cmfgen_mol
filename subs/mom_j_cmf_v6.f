...
!
	...
	REAL(KIND=LDP), ALLOCATABLE :: RSQN_ON_RSQJ_COEF(:,:)
!
...
!
	...
	REAL(KIND=LDP), ALLOCATABLE :: RSQN_ON_RSQJ(:)
	REAL(KIND=LDP), ALLOCATABLE :: F_SAV(:)
	REAL(KIND=LDP), ALLOCATABLE :: G_SAV(:)
	REAL(KIND=LDP), ALLOCATABLE :: RSQN_ON_RSQJ_SAV(:)
!
...
!
	REAL(KIND=LDP) F_SM(ND_SM),G_SM(ND_SM),RSQN_ON_RSQJ_SM(ND_SM)
	REAL(KIND=LDP) JNU_SM(ND_SM),RSQHNU_SM(ND_SM)
