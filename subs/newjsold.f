...
C
	INTEGER NC,ND,NP
	REAL(10) TA(ND),TB(ND),TC(ND),XM(ND),WM(ND,ND)
	REAL(10) FB(ND,ND),RJ(ND),DTAU(ND),R(ND),Z(ND),ZETA(ND)
	REAL(10) THETA(ND),CHI(ND),dCHIdr(ND),AQW(ND,NP),P(NP)
	REAL(10) DBB,IC
C
	LOGICAL DIFF,THK
	CHARACTER*6 METHOD
C
	REAL(10) DBC,IBOUND,TOR
	INTEGER I,LS,NI,KS
