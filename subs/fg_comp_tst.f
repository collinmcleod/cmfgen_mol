...
C
	...
	REAL(10) IN_HBC(NLF+1),HBC(3,NLF+1),NBC(3,NLF+1)
C
...
C
	...
	REAL(10) JPREV(ND),AVCONT(ND),CVCONT(ND),dCHIdR(ND)
C
C Local variables.
C
	INTEGER, PARAMETER :: IONE=1
	INTEGER I,J,LS,ML,NI,NIEXT
	REAL(10) OLDCHI,DBC,SCALE,HBLANK,IBOUND,IMIN,IMINOLD,IMIN_dSL
	REAL(10) T1,S1,TOR,DNU,WERF_EXP
C
