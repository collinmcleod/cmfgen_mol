...
C
	...
	REAL(10) TA(ND),TB(ND),TC(ND),XM(ND),R(ND),Z(ND),CHI(ND),dCHIdr(ND)
	REAL(10) RJ(ND),NEWRJ(ND),NEWRK(ND),DTAU(ND),Q(ND),F(ND)
	REAL(10) AQW(ND,NP),AQW3(ND,NP),P(NP),LUM,HBC,HBCNEW,E1,E2,E3
	REAL(10) DBC,DBB,T1,T2,IC
	CHARACTER*6 METHOD
	LOGICAL DIFF
C
