...
!
	INTEGER N_LST
!
	REAL(10), ALLOCATABLE :: LST_WAVE(:)
	REAL(10), ALLOCATABLE :: LST_GAM_RAD(:)
	REAL(10), ALLOCATABLE :: LST_GAM_COL(:)
	REAL(10), ALLOCATABLE :: LST_V_PROF_LIMIT(:)
!
...
!
	REAL(10), ALLOCATABLE :: INT_WRK(:)
	REAL(10), ALLOCATABLE :: DP_WRK(:)
