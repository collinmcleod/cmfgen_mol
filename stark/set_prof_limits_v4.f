	...
	VEC_VDOP_MIN=1.0E+50_LDP			!Very large number
	  ...
	  VEC_VDOP_MIN=MIN(VEC_VDOP_MIN,NU_DOP(I))			!kms
	   ...
	   IF(PROF_TYPE .EQ. 'LIST_VGT')THEN
	     LOC_GAM_RAD=GAM_RAD
	     LOC_GAM_COL=1.55E+04_LDP*(ABS(GAM_COL)**0.667_LDP)		!GAM_COL
	     PROF_TYPE='VOIGT'
	   END IF
	END DO
!
...
!            WRITE(178,'(8ES14.4)')NU_ZERO,C_KMS*dNU/NU_ZERO,C_KMS*(VEC_STRT_FREQ/NU_ZERO-1.0D0),
!	1                 LOC_GAM_RAD,LOC_GAM_COL,
!	1                 LINE_TO_CONT_RATIO(ND),LINE_TO_CONT_RATIO(ND-10),
!	1                 LINE_TO_CONT_RATIO(ND-20)
	  ELSE
!
...
!
	VEC_STRT_FREQ=NU_ZERO*(1.0_LDP+LOCAL_V_PROF_LIMIT/C_KMS)
!
