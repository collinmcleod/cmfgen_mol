	...
	INTEGER, PARAMETER :: NFREQ=301	!Must be odd
!
	LOGICAL, PARAMETER :: L_FALSE=.FALSE.
	LOGICAL, PARAMETER :: L_TRUE=.TRUE.
	LOGICAL, PARAMETER :: LU_STK=20
!
	REAL(10) ED_IN(ND_MAX)
	REAL(10) TEMP_IN(ND_MAX)
	REAL(10) CHIL(ND_MAX)
	REAL(10) VDOP_IN(ND_MAX)
	REAL(10) ZERO_VEC(ND_MAX)
!
	REAL(10) PROF(NFREQ,ND_MAX)
	REAL(10) PRO_VEC(ND_MAX)
	REAL(10) NU(NFREQ),LAM(NFREQ)
	REAL(10) VEL_KMS(NFREQ),LOGLAM(NFREQ)
	REAL(10) NORM(ND_MAX)
	REAL(10) Z_IN,AMASS_IN
	REAL(10) C_KMS
	REAL(10) VTURB
	REAL(10) VTURB_FIX
	REAL(10) GAM_NAT
...
!
	REAL(10) LAM_VAC,SPEED_OF_LIGHT
