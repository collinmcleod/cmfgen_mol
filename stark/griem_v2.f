...
!
      ...
      LOGICAL RET_LOG
!
      REAL(10), PARAMETER :: CLIGHT=2.997925D18
      REAL(10), PARAMETER :: VLIGHT=2.997925D10
      REAL(10), PARAMETER :: CBOLTZ=1.3805D-16
      REAL(10), PARAMETER :: AMU=1.67333D-24
      REAL(10), PARAMETER :: THIRD=0.333333333D0
      REAL(10), PARAMETER :: GAMIN=0.01D0
      REAL(10), PARAMETER :: GAMAX=25.0D0
      REAL(10), PARAMETER :: PI=3.1415926536E0
!
      REAL(10) AA,ASQ,BSQ,FRQ,WAVE
      REAL(10) CON,OBA,WSQ,CCKAB,BETP1,BETW1
      REAL(10) RYD
      REAL(10) GAM01,GAM02
      REAL(10) EE,SRE,CUE
      REAL(10) F0,TT,SRT
      REAL(10) DOP
!
      REAL(10) BETA,BETAP,BETAW
      REAL(10) GAMA,GAM0,GAML,GAMW
      REAL(10) FPW,SSS,REN,FAC
      REAL(10) CKABD,OCKAB
!
      INTEGER I,JP,JM
!
...
! 
!
      REAL(10) FUNCTION DCONV_STRK(DLAM)
      USE GRIEM_STARK_MOD
      IMPLICIT NONE
!
      REAL(10) DLAM
...
! 
      REAL(10), PARAMETER :: HALF=0.5E0
      REAL(10), PARAMETER :: ZERO=0.0E0
      REAL(10), PARAMETER :: SRTPI=5.6418958E-1
      REAL(10), PARAMETER :: RANGE=6.0E0
!
      REAL(10) X(NS),ERX(NS),EX(NS)
      REAL(10) DB,X1,CON
      REAL(10) XN,DX,GR,CR,TEX,TERX
      INTEGER I,J,JM,N0
!
! Functions called
!
...
C BY S SEGMENT
   ...
   60 DCONV_STRK=DCONV_STRK+HALF*(TERX-SRTPI*TEX)
      ...
      END
!
      REAL(10) FUNCTION TBG_STRK(BET,GAM)
      IMPLICIT NONE
!
      REAL(10) BET,GAM
!
      REAL(10), PARAMETER :: PI=3.14159265358979
!
! Functions called.
!
      REAL(10) TF_STRK
...
C 
C
      REAL(10) FUNCTION TG_STRK(BET,GAM)
      IMPLICIT NONE
!
      REAL(10) BET,GAM
!
      REAL(10), PARAMETER :: C4=1.5D0
      REAL(10), PARAMETER :: C5=3.4636008D1
      REAL(10), PARAMETER :: C6=-1.3253986E2
      REAL(10), PARAMETER :: PI2=1.57079632679489
!
      REAL(10) G2,B,C,BET2,CC,R
      REAL(10) P,P2,Q,Q2
      REAL(10) SINA,COSA2,SINA2
      REAL(10) Y1,Y2
      REAL(10) X1,X2,X3,X4,X5
      REAL(10) D1,D2,D3,D4,D5,D6,D7,D8,D9
      REAL(10) SUM1,SUM2,SUM3,SUM4
!
      G2=GAM*GAM
      B=2.0  *BET
      C=BET*BET+G2
...
! 
!
      REAL(10) FUNCTION TF_STRK(B,G)
      IMPLICIT NONE
!
      REAL(10) B
      REAL(10) G
!
      REAL(10), PARAMETER :: C0=1.0007744D-01
      REAL(10), PARAMETER :: C1=4.93208719D-03
      REAL(10), PARAMETER :: C2=-7.09873526D-03
      REAL(10), PARAMETER :: C3=7.11559325D-04
!
      REAL(10) X1,G2
      REAL(10) D,D1,D2,D3
!
...
!
      ...
      REAL(10), PARAMETER :: C4=1.5D0
      REAL(10), PARAMETER :: C5=3.4636008D1
      REAL(10), PARAMETER :: C6=-1.3253986D2
!
      REAL(10) B,B2,SRT
!
      B=ABS(X)
...
! 
!
      REAL(10) FUNCTION ASINT_STRK(X0,X1,DB)
      USE GRIEM_STARK_MOD
      IMPLICIT NONE
!
      REAL(10) X0,X1,DB
...
!
      REAL(10), PARAMETER :: SRTPI=5.6418958D-1
      REAL(10), PARAMETER :: C23=6.666666667D-1
      REAL(10), PARAMETER :: HALF=0.5D0
      REAL(10), PARAMETER :: ONE=1.0D0
      REAL(10), PARAMETER :: TWO=2.0D0
      REAL(10), PARAMETER :: STEP=0.2D0
!
      INTEGER I,N
      REAL(10) H,X,DX
!
...
! 
!
      REAL(10) FUNCTION DOPLER_STRK(X)
      IMPLICIT NONE
!
      REAL(10) X,SQ
      SQ=X*X
