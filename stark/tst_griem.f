...
C
	...
	REAL(10) NU(NFREQ),LAM(NFREQ),LOGLAM(NFREQ)
	REAL(10) ED_IN(ND_MAX),TEMP_IN(ND_MAX),VDOP_IN(ND_MAX)
...
C
	...
	REAL(10) DEL_NU,T1,RHYD,LAM_ZERO,NU_ZERO
C
	REAL(10) KTH_LAM(17),KTH_GRI(17)
