...
! Created 18-Dec-1995
!
	INTEGER*4 ID			!Species identifier (integer key)
	INTEGER*4 NXzV			!Number of levels in FULL atom
...
!
	...
	CHARACTER*60 TRANSDIE
	CHARACTER*30 LS_NAME
!
...
!
	...
	INTEGER*4, ALLOCATABLE :: VEC_INDX(:)
!
	REAL*8, ALLOCATABLE :: DIE_LEV_G(:)
	REAL*8, ALLOCATABLE :: DIE_LEV_ENERGY(:)
	REAL*8, ALLOCATABLE :: DIE_LEV_AUTO(:)
	CHARACTER*30, ALLOCATABLE :: DIE_LEV_NAME(:)
!
	INTEGER*4 NUM_D_RD
	INTEGER*4 NUM_FREE_FREE
	INTEGER*4 NUM_LEVELS
!
	INTEGER*4 I,J,LOOP,IOS,L1,L2,LUER
	INTEGER*4 MNL,MNL_CNT,CNT,CNT_BEG
	INTEGER*4 INC,WIINC,MIS,WIMIS,INDX_HASH
!
	INTEGER*4 NUM_OF_MATCHES
	INTEGER*4 LOW_PNT
	INTEGER*4 UP_PNT 
	CHARACTER*30 LOW_NAME
	CHARACTER*30 UP_NAME
