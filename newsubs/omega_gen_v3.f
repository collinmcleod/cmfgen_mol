...
!
	...
	CHARACTER*(*) FILE_NAME
	INTEGER*4 ID                    !Indicates species for photoiozation data
!
	INTEGER*4 ERROR_LU
	LOGICAL SAME_N
	EXTERNAL ERROR_LU
...
!
	...
	INTEGER*4, SAVE :: ID_LOW(MAX_TRANS)
	INTEGER*4, SAVE :: ID_UP(MAX_TRANS)
	INTEGER*4, SAVE :: ID_INDX(MAX_TRANS)
	REAL*8, SAVE :: T_TABLE(MAX_TVALS)
	REAL*8, SAVE :: OMEGA_TABLE(MAX_TAB_SIZE)
	REAL*8, SAVE :: OMEGA_SET,OMEGA_SCALE
	INTEGER*4, SAVE :: NUM_TRANS,NUM_TVALS
...
!
	...
	INTEGER*4 J		!Used for upper level.
	INTEGER*4 PHOT_ID
	INTEGER*4 L,K,LUER,IFAIL
!
