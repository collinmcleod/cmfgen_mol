...
!
	...
	REAL*8 ZXzV
	REAL*8 AT_NO_DUM
	INTEGER*4 XzV_ION_LEV_ID(MAX_N_PHOT)
	INTEGER*4 ID
	CHARACTER*(*) DESC
!
	LOGICAL XzSIX_PRES
	...
	INTEGER*4 F_TO_S_XzSIX(NXzSIX_F)
...
!
	INTEGER*4 NTERMS(MAX_N_PHOT)
	INTEGER*4 N_DP(MAX_N_PHOT)
	CHARACTER*30, ALLOCATABLE :: LOC_TERM_NAME(:)
!
	REAL*8 LOC_EXC_FREQ_ION,TOTAL_WT
	REAL*8 T1,NU_INF
	CHARACTER*20 CROSS_UNIT
	INTEGER*4 PHOT_ID,IOS
	INTEGER*4 I,J,K
	INTEGER*4 N_HD,L1,L2,LN
	INTEGER*4 NEXT,LUER
	INTEGER*4 END_CROSS
	INTEGER*4 NPNTS
!
