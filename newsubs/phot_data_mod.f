...
!
	  REAL(10), POINTER :: NU_NORM(:)		!MAX_CROSS
	  REAL(10), POINTER :: CROSS_A(:)               !MAX_CROSS
          REAL(10), POINTER :: NEF(:,:)                 !NLOC,NS
	  REAL(10), POINTER :: EXC_FREQ(:)              !NS
	  REAL(10), POINTER :: GION(:)              	!NS
...
!
	  REAL(10), POINTER :: LST_CROSS(:,:)		!NLOC,NS
	  REAL(10), POINTER :: LST_FREQ(:,:)		!NLOC,NS
	  REAL(10), POINTER :: LST_LOC(:,:)		!NLOC,NS
!
	  REAL(10) AT_NO
	  REAL(10) ZION
	  REAL(10) ALPHA_BF
...
!
	  INTEGER NDIE_MAX
	  REAL(10), POINTER :: OSC(:)			!NDIE_MAX
	  REAL(10), POINTER :: GAMMA(:)			!NDIE_MAX
!
...
!
	  REAL(10), POINTER :: NU_ZERO(:)		!NDIE_MAX
	  REAL(10), POINTER :: NU_MAX(:)		!NDIE_MAX
	  REAL(10), POINTER :: NU_MIN(:)		!NDIE_MAX
!
...
!
	  REAL(10), POINTER :: FF_GF(:)
	  REAL(10), POINTER :: FF_GAMMA(:)
!
...
!
	  REAL(10), POINTER :: FF_NU_ZERO(:)
	  REAL(10), POINTER :: FF_NU_EXCITE(:)
	  REAL(10), POINTER :: FF_NU_MAX(:)
	  REAL(10), POINTER :: FF_NU_MIN(:)
!
	END TYPE PHOTO_DATA
!
