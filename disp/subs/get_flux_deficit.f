...
!
	REAL(10), SAVE :: IPLUS(NANG)
	REAL(10), SAVE, ALLOCATABLE :: TA(:)
	REAL(10), SAVE, ALLOCATABLE :: F(:)
	REAL(10), SAVE, ALLOCATABLE :: FOLD(:)
	REAL(10), SAVE, ALLOCATABLE :: RJ(:)
	REAL(10), SAVE, ALLOCATABLE :: HNU(:)
	REAL(10), SAVE, ALLOCATABLE :: NEWRJ(:)
	REAL(10), SAVE, ALLOCATABLE :: SOURCE(:)
	REAL(10), SAVE, ALLOCATABLE :: ZETA(:)
	REAL(10), SAVE, ALLOCATABLE :: THETA(:)
!
	IF(FIRST_TIME)THEN
