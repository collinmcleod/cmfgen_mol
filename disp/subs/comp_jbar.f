...
!
	REAL(10) RJ(ND)
	REAL(10) RJ_ES(ND)
	REAL(10) RJ_STORE(ND,NLF)
	REAL(10) RJ_ES_STORE(ND,NLF)
!
	REAL(10) LAM(NLF)
	REAL(10) RSQ_LF_STORE(NLF,ND)
	REAL(10) RSQH_STORE(NLF,ND)
	REAL(10) RSQJ_STORE(NLF,ND)
!
	REAL(10) ETA(ND)
	REAL(10) CHI(ND)
	REAL(10) RH(ND)
	...
	REAL(10) FORCE_MULT_FG(ND)
!
	REAL(10) CHI_PREV(ND)
	REAL(10) ETA_PREV(ND)
	REAL(10) FEDD_PREV(ND)
	REAL(10) GEDD_PREV(ND)
	REAL(10) JNU_PREV(ND)
	REAL(10) RSQHNU_PREV(ND)
	REAL(10) N_ON_J_PREV(ND)
!
	REAL(10) TA(ND)
	REAL(10) TB(ND)
	REAL(10) TC(ND)
