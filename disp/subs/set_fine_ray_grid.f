...
!
	...
	REAL*8, ALLOCATABLE :: MUV_RAY(:)
	REAL*8, ALLOCATABLE :: Z_RAY(:)
	REAL*8, ALLOCATABLE :: DEN_RAY(:)
	REAL*8, ALLOCATABLE :: ETAL_RAY(:)
	REAL*8, ALLOCATABLE :: CHIL_RAY(:)
	REAL*8, ALLOCATABLE :: TAUL(:)
	REAL*8, ALLOCATABLE :: TA(:)
	REAL*8, ALLOCATABLE :: TB(:)
	REAL*8, ALLOCATABLE :: TC(:)
	REAL*8, ALLOCATABLE :: INDX_RAY(:)
	REAL*8, ALLOCATABLE :: ABS_PROF(:)

	REAL*8 ::  STORED_DEL_V=5000.0
...
!
	...
	SUBROUTINE NON_SOB_TAUL(VSHIFT,VDOP,LINE_FREQ,METHOD,TYPE_ATM,XAXIS_OPT)
	USE FINE_RAY_GRID
	IMPLICIT NONE
!
	REAL*8 VSHIFT		!In km/s
	REAL*8 VDOP		!In km/s
	REAL*8 LINE_FREQ	!In units of 10^15 Hz
