...
!
	...
	REAL(10), ALLOCATABLE :: MUV_RAY(:)
	REAL(10), ALLOCATABLE :: Z_RAY(:)
	REAL(10), ALLOCATABLE :: DEN_RAY(:)
	REAL(10), ALLOCATABLE :: ETAL_RAY(:)
	REAL(10), ALLOCATABLE :: CHIL_RAY(:)
	REAL(10), ALLOCATABLE :: TAUL(:)
	REAL(10), ALLOCATABLE :: TA(:)
	REAL(10), ALLOCATABLE :: TB(:)
	REAL(10), ALLOCATABLE :: TC(:)
	REAL(10), ALLOCATABLE :: INDX_RAY(:)
	REAL(10), ALLOCATABLE :: ABS_PROF(:)
!
	REAL(10) :: RSTAR
	REAL(10) ::  STORED_DEL_V=5000.0
...
!
	...
	IMPLICIT NONE
!
	REAL(10) VSHIFT		!In km/s
	REAL(10) VDOP		!In km/s
	REAL(10) LINE_FREQ	!In units of 10^15 Hz
