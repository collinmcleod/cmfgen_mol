...
C
	...
	REAL(10) HBC(NLF+1),NBC(NLF+1),IN_HBC(NLF+1)
...
C
	...
	REAL(10) TA(NV),TB(NV),TC(NV),DTAU(NV),TCHI(NV),TCHIPREV(NV)
	REAL(10) XM(NV),SOURCE(NV),MIDF(NV),Q(NV),JEX_SCAT(NV)
...
C
	INTEGER I,ML
	REAL(10) T1,T2,T3,DNU,SCALE,MID_PRO
C
