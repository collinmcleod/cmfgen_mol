...
!
	...
	REAL(10) HYD(NHYD,ND),LOG_HYDLTE(NHYD,ND),WHYD(NHYD,ND)
	REAL(10) EDGEHYD(NHYD),GHYD(NHYD)
	REAL(10) DHYD(NION,ND),R(ND),T(ND),ED(ND),V(ND),CLUMP_FAC(ND)
	REAL(10) LUM
	REAL(10) GION
!
...
!
	REAL(10) LOG_TEN
	REAL(10) RCORE
	REAL(10) T1,T2,T3,CONST,DELTA_T
	REAL(10) TEXCITE(NHYD)
