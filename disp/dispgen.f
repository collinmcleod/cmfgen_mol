C
	...
	IMPLICIT NONE
!
! Altered 07-Jun-2022 : updated to match changes in hillier/cur_cmf/
...
!
	!Molecules added by Collin McLeod:
!
	ID=ID+1
	AT_NO(ID)=101.0D0;          AT_MASS(ID)=28.01D0         !Molecule - Carbon Monoxide
	SPECIES(ID)='COMOL';        SPECIES_ABR(ID)='COM'
	SOL_ABUND_HSCL(ID)=1.0D0
!
	ID=ID+1
	AT_NO(ID)=102.0D0;          AT_MASS(ID)=24.02D0         !Molecule - Diatomic Carbon
	SPECIES(ID)='C2MOL';        SPECIES_ABR(ID)='C2M'
	SOL_ABUND_HSCL(ID)=1.0D0
!
	ID=ID+1
	AT_NO(ID)=103.0D0;          AT_MASS(ID)=31.998D0        !Molecule - Diatomic Oxygen
	SPECIES(ID)='O2MOL';        SPECIES_ABR(ID)='O2M'
	SOL_ABUND_HSCL(ID)=1.0D0
!
	ID=ID+1
	AT_NO(ID)=104.0D0;          AT_MASS(ID)=44.008D0        !Molecule - Carbon Dioxide
	SPECIES(ID)='CO2MOL';       SPECIES_ABR(ID)='CO2M'
	SOL_ABUND_HSCL(ID)=1.0D0
!
	ID=ID+1
	AT_NO(ID)=105.0D0;          AT_MASS(ID)=40.018D0        !Molecule - Diarbon Monoxide
...
C
	...
	END DO
C
	CALL RD_RVTJ_PARAMS_V4(RMDOT,RLUM,ABUND(1),TIME,NAME_CONVENTION,
