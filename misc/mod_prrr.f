...
!
!
	REAL(10), ALLOCATABLE :: PHOT(:,:)
	REAL(10), ALLOCATABLE :: RECOM(:,:)
	REAL(10), ALLOCATABLE :: RECOM_SUM(:)
	REAL(10), ALLOCATABLE :: PHOT_SUM(:)
	REAL(10), ALLOCATABLE :: COL_IR(:)
	REAL(10), ALLOCATABLE :: CHG_IR(:)
	REAL(10), ALLOCATABLE :: NT_IR(:)
	REAL(10), ALLOCATABLE :: COL_RR(:)
	REAL(10), ALLOCATABLE :: XRAY_RR(:)
	REAL(10), ALLOCATABLE :: RR_COEF(:)
	REAL(10), ALLOCATABLE :: CHG_RR(:)
	REAL(10), ALLOCATABLE :: ADVEC_RR(:)
!
	REAL(10), ALLOCATABLE :: R(:)
	REAL(10), ALLOCATABLE :: V(:)
	REAL(10), ALLOCATABLE :: TEMP(:)
	REAL(10), ALLOCATABLE :: ED(:)
	REAL(10), ALLOCATABLE :: DI(:)
!
	REAL(10), ALLOCATABLE :: XVEC(:)
	REAL(10), ALLOCATABLE :: YVEC(:)
	REAL(10), ALLOCATABLE :: TOT_SUM(:)
!
	REAL(10), ALLOCATABLE :: YLEV(:)
	REAL(10), ALLOCATABLE :: XLEV(:)
!
	INTEGER ND
	INTEGER NV
	INTEGER I,J,K,L
