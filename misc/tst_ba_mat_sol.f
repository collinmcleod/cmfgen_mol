!
! Porgram to test the solution of the large martices generated by
! CMFGEN. The routine reads in the file BA_ASCI_N_D1 and generates
! the solution.
!
...
!
	...
	N=IUP-ILOW+1
!
	CALL SOLVE_BA_MAT(NT,N,ILOW,IUP)
!
	STOP
	END
! 
!
	SUBROUTINE SOLVE_BA_MAT(NT,N,ILOW,IUP)
	USE GEN_IN_INTERFACE
	IMPLICIT NONE
!
	INTEGER N,NT
...
!
	HDKT=4.7994145
!
	OPEN(UNIT=10, FILE='BA_ASCI_N_D1',STATUS='OLD',ACTION='READ')
	  STRING=' '
...
!
	...
	DO J=1,N
	  DO I=1,N
	    ...
	    RHS(I)=RHS(I)+T1
	    IF(I .EQ. 182)WRITE(17,'(2I5,2ES14.4)')I,J,SAV_CMAT(I,J)/POPS(J),T1
	  END DO
	END DO
!
	DO I=1,N
