...
!
	...
	REAL(10) T(ND_MAX)
	REAL(10) ED(ND_MAX)
	REAL(10) PER_CR(ND_MAX)
	REAL(10) NET_CR(ND_MAX)
	REAL(10) COOL_TIME(ND_MAX)
	REAL(10) XV(ND_MAX)
	REAL(10) YV(ND_MAX)
	REAL(10) TOTAL(ND_MAX)
	REAL(10) TMP_VEC(ND_MAX)
	REAL(10) LUM(NREC_MAX)
	REAL(10) T1,T2
	REAL(10) LSTAR,LSUN
!
	REAL(10), ALLOCATABLE :: RATE(:,:)
	REAL(10), ALLOCATABLE :: VRATE(:,:)
	REAL(10), ALLOCATABLE :: dLUM(:,:)
	REAL(10), ALLOCATABLE :: TMP_RATE(:,:)
!
