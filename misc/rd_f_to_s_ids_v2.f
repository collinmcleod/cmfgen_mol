...
C
	...
	1LUIN,FILENAME,SL_OPTION,IS_MOL)
	USE SET_KIND_MODULE
	IMPLICIT NONE
C
! Altered 03-Jan-2024 : added use of SET_KIND_MODULE	
! Altered 22-Mar-2022 : altered by Collin McLeod again: added is_mol to arguments: do not split
!                     : levels for molecules regardless of N_S
! Altered 09-Feb-2022 : altered by Collin McLeod: do not split levels if N_S=1 (molecules)
