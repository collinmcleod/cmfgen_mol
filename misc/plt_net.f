...
!
	REAL(10), ALLOCATABLE :: TOT_PHOT_RATE(:)
	REAL(10), ALLOCATABLE :: TOT_REC_RATE(:)
	REAL(10), ALLOCATABLE :: COL_ION_RATE(:)
	REAL(10), ALLOCATABLE :: COL_REC_RATE(:)
	REAL(10), ALLOCATABLE :: ADV_REC_RATE(:)
	REAL(10), ALLOCATABLE :: NT_ION_RATE(:)
	REAL(10), ALLOCATABLE :: XRAY_REC_RATE_PS(:)
	REAL(10), ALLOCATABLE :: XRAY_REC_RATE_GS(:)
	REAL(10), ALLOCATABLE :: REC_COEF(:)
	REAL(10), ALLOCATABLE :: NET(:)
!
