...
!
	...
	REAL(10) IRAT(MAX_ND)
	REAL(10) VEL(MAX_ND)
	REAL(10) CLUMP_FAC(MAX_ND)
	REAL(10) OLD_TAU(MAX_ND)
	REAL(10) TAU_SAV(MAX_ND)
!
	REAL(10) RTMP(MAX_ND)
	REAL(10) OLD_XV(MAX_ND)
	REAL(10) NEW_XV(MAX_ND)
	REAL(10) NEW_TAU(MAX_ND)
	REAL(10) NEW_VEL(MAX_ND)
	REAL(10) TAU(MAX_ND)
!
	REAL(10) RMIN,RMAX,LUM
	REAL(10) GRID_FACTOR,GRID_RATIO
	REAL(10) T1,T2,SCALE_FACTOR,DELR
	REAL(10) TAU_MIN,TAU_MAX
	REAL(10) TAU_RAT
	REAL(10) R_SCALE_FAC
	REAL(10) IB_RAT
	REAL(10) OB_RAT
...
!
	REAL(10) RTMP(NEW_ND)
	REAL(10) NEW_DI(NEW_ND)
	REAL(10) NEW_ED(NEW_ND)
	REAL(10) NEW_T(NEW_ND)
	REAL(10) NEW_IRAT(NEW_ND)
	REAL(10) NEW_VEL(NEW_ND)
	REAL(10) NEW_CLUMP_FAC(NEW_ND)
	REAL(10) NEW_TAU(NEW_ND)
	REAL(10) NEW_SIGMA(NEW_ND)
	REAL(10) COEF(NEW_ND,4)
!
	LOGICAL RD_MEANOPAC
!
	REAL(10) T1
