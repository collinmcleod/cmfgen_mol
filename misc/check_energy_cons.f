...
!
	...
	INTEGER ND
!
	REAL(10) CMF_LUM(ND_MAX)
	REAL(10) MECH_LUM(ND_MAX)
	REAL(10) DECAY_LUM(ND_MAX)
	REAL(10) DR4J_LUM(ND_MAX)
	REAL(10) INTERN_LUM(ND_MAX)
!
	REAL(10) E_RAD(NMAX)
	REAL(10) L_OBS(NMAX)
	REAL(10) L_CMF(NMAX)
	REAL(10) L_MECH(NMAX)
	REAL(10) L_DECAY(NMAX)
	REAL(10) L_DR4J(NMAX)
	REAL(10) L_INTERN(NMAX)
	REAL(10) E_CONS(NMAX)
!
	REAL(10) LAMC
