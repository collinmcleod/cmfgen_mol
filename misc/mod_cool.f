...
!
	...
	REAL*8, ALLOCATABLE :: COL_RATE(:)
	REAL*8, ALLOCATABLE :: BF_RATE(:)
	REAL*8, ALLOCATABLE :: FF_RATE(:)
	REAL*8, ALLOCATABLE :: XKS_RATE(:)
	REAL*8, ALLOCATABLE :: NT_RATE(:)
	REAL*8, ALLOCATABLE :: CHG_RATE(:)
	REAL*8, ALLOCATABLE :: ART_HT(:)
	REAL*8, ALLOCATABLE :: AC_RV(:)
