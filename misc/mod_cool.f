...
!
	...
	REAL(10) VALS(MAX_RECS,10)
	REAL(10) TA(MAX_RECS)
	INTEGER INDX(MAX_RECS)
!
	REAL(10), ALLOCATABLE :: BOUND(:)
	REAL(10), ALLOCATABLE :: SUM(:)
	REAL(10), ALLOCATABLE :: TOTAL_RATE(:)
	REAL(10), ALLOCATABLE :: ED(:)
	REAL(10), ALLOCATABLE :: ATOM_DENSITY(:)
	REAL(10), ALLOCATABLE :: T(:)
	REAL(10), ALLOCATABLE :: R(:)
	REAL(10), ALLOCATABLE :: V(:)
	REAL(10), ALLOCATABLE :: NET_RATE(:)
	REAL(10), ALLOCATABLE :: COOLING_TIME(:)
!
	REAL(10), ALLOCATABLE :: RAD_DECAY(:)
	REAL(10), ALLOCATABLE :: COL_RATE(:)
	REAL(10), ALLOCATABLE :: BF_RATE(:)
	REAL(10), ALLOCATABLE :: FF_RATE(:)
	REAL(10), ALLOCATABLE :: XKS_RATE(:)
	REAL(10), ALLOCATABLE :: NT_RATE(:)
	REAL(10), ALLOCATABLE :: CHG_RATE(:)
	REAL(10), ALLOCATABLE :: ART_HT(:)
	REAL(10), ALLOCATABLE :: AC_RV(:)
	REAL(10), ALLOCATABLE :: AC_RdT(:)
!
	INTEGER ND
	INTEGER NV
	INTEGER I,J,K,ID
...
!
	...
	TOTAL_RATE=TOTAL_RATE+AC_RdT+CHG_RATE-RAD_DECAY-ART_HT
	DO ID=1,ND,10
...
!
	...
	INTEGER ID, ND
	REAL(10) TOTAL_RATE(ND)
	REAL(10) SPECIFIC_RATE(ND)
	REAL(10) TEMP_VEC(ND)
