...
!
	...
	REAL(10) T1,T2,T3,T4
	REAL(10) STAR_MASS
	REAL(10) GRAVITATIONAL_CONSTANT, MASS_SUN,BOLTZMANN_CONSTANT
...
!
	TYPE HYDRO_DATA
	  ...
	  REAL(10), ALLOCATABLE :: VEL(:)
	  REAL(10), ALLOCATABLE :: dVdR(:)
	  REAL(10), ALLOCATABLE :: VdVdR(:)
	  REAL(10), ALLOCATABLE :: dPdR(:)
	  REAL(10), ALLOCATABLE :: dTPdR(:)
	  REAL(10), ALLOCATABLE :: REQ(:)
	  REAL(10), ALLOCATABLE :: GRAD(:)
	  REAL(10), ALLOCATABLE :: GELEC(:)
	  REAL(10), ALLOCATABLE :: GAM(:)
	  REAL(10), ALLOCATABLE :: GTOT(:)
	  REAL(10), ALLOCATABLE :: GRAV(:)
	  REAL(10), ALLOCATABLE :: ED(:)
	  REAL(10), ALLOCATABLE :: ATOM(:)
	  REAL(10), ALLOCATABLE :: TEMP(:)
	  REAL(10), ALLOCATABLE :: GAS_PRES(:)
	  REAL(10), ALLOCATABLE :: TA(:)
	  REAL(10), ALLOCATABLE :: TB(:)
	  REAL(10), ALLOCATABLE :: XVEC(:)
	  REAL(10), ALLOCATABLE :: YVEC(:)
	  REAL(10), ALLOCATABLE :: ZVEC(:)
	  REAL(10), ALLOCATABLE :: SOUND(:)
	  REAL(10), ALLOCATABLE :: TAU(:)
	  REAL(10), ALLOCATABLE :: CLUMP_FAC(:)
	  REAL(10), ALLOCATABLE :: DENSITY(:)
	  REAL(10), ALLOCATABLE :: TAU_FLUX(:)
	  REAL(10), ALLOCATABLE :: FLUX_MEAN(:)
	  REAL(10) STARS_MASS
	  REAL(10) STARS_MDOT
	  REAL(10) DEP_WIND_MOM
	  REAL(10) WIND_MOM_MDOT
	  REAL(10) TAU_SONIC
	  REAL(10) R_SONIC
	  REAL(10) C_SONIC
	  INTEGER ND
