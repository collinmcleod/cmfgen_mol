...
!
	...
	REAL(10) ENERGY(NLEV)
	REAL(10) G(NLEV)
	REAL(10) LAM_EDGE(NLEV)
	REAL(10) E_STRT(NLEV)
!
	REAL(10) EDGE_SUM(NLEV)
	REAL(10) G_SUM(NLEV)
	REAL(10) FOSC(NLEV,NLEV)
!
	REAL(10) GF_CUT
	INTEGER GF_LEV_CUT
...
!
	...
	REAL(10), ALLOCATABLE :: EDGE_PACK(:)
	REAL(10), ALLOCATABLE :: FOSC_PACK(:,:)
	REAL(10), ALLOCATABLE :: G_PACK(:)
	REAL(10), ALLOCATABLE :: RECOM_PACK(:,:)
	REAL(10), ALLOCATABLE :: ARAD(:)
	REAL(10), ALLOCATABLE :: GAM2(:)
	REAL(10), ALLOCATABLE :: GAM4(:)
...
!
	REAL(10), ALLOCATABLE :: FLOW_SUM(:)
	REAL(10), ALLOCATABLE :: FHIGH_SUM(:)
	REAL(10), ALLOCATABLE :: ALOW_SUM(:)
	REAL(10), ALLOCATABLE :: AHIGH_SUM(:)
	LOGICAL, ALLOCATABLE :: LEVEL_DONE(:)
!
	REAL(10), ALLOCATABLE :: FOSC_TMP(:,:)
