...
!
	REAL(10) INDX(NCF_MAX)
	REAL(10) NU(NCF_MAX)
	REAL(10) LAM(NCF_MAX)
!
	REAL(10) JM_OUT(NCF_MAX)
	REAL(10) JR_OUT(NCF_MAX)
	REAL(10) DIFF_OUT(NCF_MAX)
	REAL(10) HBC_CMF(NCF_MAX)
!
	REAL(10) JM_IN(NCF_MAX)
	REAL(10) JR_IN(NCF_MAX)
	REAL(10) DIFF_IN(NCF_MAX)
!
	REAL(10) YV(NCF_MAX)
!
