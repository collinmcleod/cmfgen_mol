...
!
	REAL(KIND=LDP) INDX(NCF_MAX)
	REAL(KIND=LDP) NU(NCF_MAX)
	REAL(KIND=LDP) LAM(NCF_MAX)
!
	REAL(KIND=LDP) JM_OUT(NCF_MAX)
	REAL(KIND=LDP) JR_OUT(NCF_MAX)
	REAL(KIND=LDP) DIFF_OUT(NCF_MAX)
	REAL(KIND=LDP) HBC_CMF(NCF_MAX)
!
	REAL(KIND=LDP) JM_IN(NCF_MAX)
	REAL(KIND=LDP) JR_IN(NCF_MAX)
	REAL(KIND=LDP) DIFF_IN(NCF_MAX)
!
