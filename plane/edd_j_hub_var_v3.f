...
!
	SUBROUTINE EDD_J_HUB_VAR_V3(VK,RHS_dHdCHI,dTAUdCHI,
...
!			 
	...
	REAL(10) dTAUdCHI(ND,ND)
	REAL(10) SOURCE(ND)
	REAL(10) CHI(ND)
	REAL(10) ESEC(ND)
	REAL(10) ES_COH_VEC(ND)
	REAL(10) DTAU(ND)
	REAL(10) R(ND)
	REAL(10) EDDF(ND)
	REAL(10) Q(ND)
	REAL(10) HU(ND),HL(ND),HS(ND),HT(ND)
	REAL(10) RSQ_DTAUONQ(ND)
	REAL(10) DERIV_SCL_FAC(ND)
	REAL(10) W(ND),WPREV(ND)
	REAL(10) DJDt(ND),DJDt_OLDt(ND)
	REAL(10) PSI(ND),PSIPREV(ND)
	REAL(10) JNU(ND)
	REAL(10) JNUM1(ND)
	REAL(10) JNU_OLDt(ND)
	REAL(10) JNU_MOD(ND)
	REAL(10) RSQ_HNUM1(ND),RSQ_HNU_OLDt(ND)
	REAL(10) dRHSdCHI_IB
	REAL(10) dRHSdCHI_OB
	REAL(10) JMIN_IB,KMIN_IB,JPLUS_IB,KPLUS_IB
	REAL(10) JMIN_OB,KMIN_OB,JPLUS_OB,KPLUS_OB
!
	INTEGER ERROR_LU
	EXTERNAL ERROR_LU
...
! Local vectors.
!
	REAL(10) dHUdCHI(ND),dHLdCHI(ND)
	REAL(10) dHSdCHI(ND),dHTdCHI(ND)
	REAL(10) dHUdTAU(ND),dHLdTAU(ND)
	REAL(10) dRHSdI(ND),dRHSdJ(ND)
!
! Local varoables.
!
	INTEGER I,J,K,L
	...
	REAL(10) MOD_DTAU
	REAL(10) dUdCHI
	REAL(10) dTAdCHI_J,dTAdCHI_I
	REAL(10) dTCdCHI_I,dTCdCHI_K
	REAL(10) dTBdCHI_J,dTBdCHI_I,dTBdCHI_K,dTBdCHI
!
! 
!
	IF(NM .LT. 2)THEN
