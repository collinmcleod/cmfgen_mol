...
!
	...
	REAL(10), ALLOCATABLE :: DTAU_H(:),DTAU_J(:)
	REAL(10), ALLOCATABLE :: GAM_RSQ_DTAUONQ(:)
	...
	REAL(10), ALLOCATABLE :: DELTA(:),DELTAH(:)
	REAL(10), ALLOCATABLE :: W(:),WPREV(:)
	REAL(10), ALLOCATABLE :: PSI(:),PSIPREV(:),PSIPREV_MOD(:)
	REAL(10), ALLOCATABLE :: EPS_A(:),EPS_B(:)
	REAL(10), ALLOCATABLE :: EPS_PREV_A(:),EPS_PREV_B(:)
	REAL(10), ALLOCATABLE :: GAM_RSQJNU_PREV(:)
	REAL(10), ALLOCATABLE :: TA_SAV(:),TB_SAV(:),TC_SAV(:),XM_SAV(:)
!
...
!
	REAL(10), ALLOCATABLE :: dTAUdCHI_H(:,:)
	REAL(10), ALLOCATABLE :: dTAUdCHI_J(:,:)
	REAL(10), ALLOCATABLE :: dHUdCHI(:)
	REAL(10), ALLOCATABLE :: dHLdCHI(:)
	REAL(10), ALLOCATABLE :: dHSdCHI(:)
	REAL(10), ALLOCATABLE :: dHUdTAU(:)
	REAL(10), ALLOCATABLE :: dHLdTAU(:)
	REAL(10), ALLOCATABLE :: EPS_FAC(:)
	REAL(10), ALLOCATABLE :: dRHSdI(:)
	REAL(10), ALLOCATABLE :: dRHSdJ(:)
