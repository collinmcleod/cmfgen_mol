...
!
	...
	REAL(10), PARAMETER :: TWOHCSQ=0.0147452575D0
	REAL(10), PARAMETER :: NU_MAX=100.0D0
	REAL(10), PARAMETER :: NU_MIN=0.0001D0
!
	REAL(10) T1
	REAL(10) FLUX
	REAL(10) X
	REAL(10) PI
	REAL(10) NORMALIZED_ANGLE_INTEGRAL
!
	INTEGER I
	INTEGER NANG
	INTEGER NCF
