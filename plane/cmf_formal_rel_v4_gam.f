...
!
	...
	REAL(10) P(NP)
	REAL(10) ETA(ND)	
	REAL(10) GAM_ETA(ND,NA)
	REAL(10) GAM_INT(ND,NA)
	REAL(10) CHI(ND)
	REAL(10) ESEC(ND)
	REAL(10) VDOP_VEC(ND)
	REAL(10) VDOP_FRAC
	...
	REAL(10) REXT_FAC
!
	REAL(10) RET_HNU_AT_IB
	REAL(10) RET_HNU_AT_OB
!
...
!
	...
	LOGICAL NEW_R_GRID
	REAL(10), DIMENSION(:), ALLOCATABLE :: ZRAY
	REAL(10), DIMENSION(:), ALLOCATABLE :: TEMPINT_M,TEMPINT_P
	INTEGER :: KDW,KDW2
!
!
!
