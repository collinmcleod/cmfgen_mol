...
!
	...
	REAL(10), ALLOCATABLE :: N_ON_J_COEF(:,:)
!
...
!
	...
	REAL(10), ALLOCATABLE :: N_ON_J_SAV(:)
!
	REAL(10), ALLOCATABLE :: JNU_PREV(:)
	REAL(10), ALLOCATABLE :: HNU_PREV(:)
...
!
	REAL(10) F_SM(ND_SM)
	REAL(10) G_SM(ND_SM)
	REAL(10) N_ON_J_SM(ND_SM)
	REAL(10) JNU_SM(ND_SM)
	REAL(10) HNU_SM(ND_SM)
