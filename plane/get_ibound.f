...
!
	...
	LOGICAL INIT
!
	REAL(10), SAVE, ALLOCATABLE :: INTENSITY(:)
	REAL(10), SAVE, ALLOCATABLE :: NU_GRID(:)
	REAL(10), SAVE, ALLOCATABLE :: ANG_GRID(:)
	REAL(10), SAVE, ALLOCATABLE :: ANG_VARIATION(:)
	REAL(10), SAVE, ALLOCATABLE :: DIST(:)
!
	REAL(10), SAVE:: FREQ_SAV=0.0D0           !Previous frequency
