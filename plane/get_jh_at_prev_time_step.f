...
!
	...
	REAL(10), ALLOCATABLE :: OLD_J(:)
	REAL(10), ALLOCATABLE :: OLD_H(:)
!
	REAL(10), ALLOCATABLE :: NUST(:)
	REAL(10), ALLOCATABLE :: JST(:,:)
	REAL(10), ALLOCATABLE :: HST(:,:)
	REAL(10), ALLOCATABLE :: H_INBC_ST(:)
	REAL(10), ALLOCATABLE :: H_OUTBC_ST(:)
!
	REAL(10), ALLOCATABLE :: NEW_J_SAV(:)
	REAL(10), ALLOCATABLE :: NEW_H_SAV(:)
	REAL(10), ALLOCATABLE :: LOG_V(:)
	REAL(10), ALLOCATABLE :: LOG_MIDV(:)
	REAL(10), ALLOCATABLE :: WRK_NEW_H(:)
!
	REAL(10), ALLOCATABLE :: LOG_OLD_V(:)
	REAL(10), ALLOCATABLE :: LOG_OLD_MIDV(:)
	REAL(10), ALLOCATABLE :: WRK_OLD_H(:)
!
	REAL(10) H_INBC_OLDT_SAV
	REAL(10) H_OUTBC_OLDT_SAV
	REAL(10), SAVE :: NU_SAV=0.0D0
!
