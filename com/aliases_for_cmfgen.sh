...
if ($machine =~ *'osiris'*)then
  ...
  setenv cmfdist ~/cmfsource
  setenv CMFDIST ~/cmfsource
  set atomic = /ihome/dhillier/hillier/cmfgen_atomic_data/atomic_9may23
  set ATOMIC = /ihome/dhillier/hillier/cmfgen_atomic_data/atomic_9may23
  set sn_atomic = /ihome/dhillier/hillier/cmfgen_atomic_data/sn_atomic
  set SN_ATOMIC = /ihome/dhillier/hillier/cmfgen_atomic_data/sn_atomic
