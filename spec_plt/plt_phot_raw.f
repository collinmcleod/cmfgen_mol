...
!
	...
	REAL(10), ALLOCATABLE :: NU_1(:)
	REAL(10), ALLOCATABLE :: CROSS_1(:)
	REAL(10), ALLOCATABLE :: ENERGY_1(:)
	REAL(10), ALLOCATABLE :: STAT_WT_1(:)
!
...
!
	...
	REAL(10), ALLOCATABLE :: NU_2(:)
	REAL(10), ALLOCATABLE :: CROSS_2(:)
	REAL(10) ZION_2
	REAL(10) GION_2 
	REAL(10) EXC_EN_2
	LOGICAL SPLITJ_2
...
!
	...
	REAL(10) XV(NCF_MAX),YV(NCF_MAX)
!
!
	INTEGER, PARAMETER :: NREC_MAX=5
	REAL(10), ALLOCATABLE :: LEVEL_INDX(:)
	REAL(10), ALLOCATABLE :: RECOM(:,:)
	REAL(10) TEMP_VEC(NREC_MAX)
	REAL(10) TOTAL_REC_VEC(NREC_MAX)
	REAL(10) LEVEL_REC_VEC(NREC_MAX)
!
	REAL(10) STAT_WEIGHT,GION,EDGE
	REAL(10) LEVEL_REC,TOTAL_REC,TEMP
	REAL(10) ANG_TO_HZ,SPEED_OF_LIGHT
