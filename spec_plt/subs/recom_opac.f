...
c
	...
	REAL SIGMA(np_max),NU(np_max),STAT_WT,GION,TEMP
c
	REAL REC(scratch),CROSS(scratch),TOT_REC
C
	REAL CHIBF,CHIFF,HDKT,TWOHCSQ,OPLIN,EMLIN
C
	INTEGER I,J,NJ,IST
	REAL T1,TP1,CONST,T2
	REAL NU_STEP,DEL_NU,DEL_NU_2,DEL_REC
	REAL FRAC_DIFF,MIN_SPACING,X,SIG
	REAL EDGE,SIG_THRESH
	REAL LST_NU
	REAL LST_CROSS
	LOGICAL EQUAL
	EXTERNAL EQUAL
