	...
	IMPLICIT NONE
!
! 05-Fev-2021: All arrays made REAL(10).
!
	INTEGER NP
	INTEGER NCF
	INTEGER NINS
...
! Local variables
!
	REAL(10), ALLOCATABLE :: P_SHRT(:)
	REAL(10), ALLOCATABLE :: P_REV(:)
	REAL(10), ALLOCATABLE :: IP_REV(:)
	REAL(10), ALLOCATABLE :: dTHETA(:)
	REAL(10), ALLOCATABLE :: QW(:)
	REAL(10), ALLOCATABLE ::  INT_COEF(:)
