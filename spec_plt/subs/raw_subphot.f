...
!
	INTEGER NCF
	INTEGER NCROSS
	REAL(10) FREQ(NCF)		!Cross-section
	REAL(10) PHOT(NCF)		!Cross-section
	REAL(10) GS_EDGE			!Energy for ionization to Ground State!
	REAL(10) EXC_FREQ
	REAL(10) AMASS
	REAL(10) ZION
!
...
!
	...
	INTEGER LST,LEND
!
	REAL(10), PARAMETER :: CONV_FAC=1.0D-08
	REAL(10), PARAMETER :: LG10_CONV_FAC=-8.0D0
!
