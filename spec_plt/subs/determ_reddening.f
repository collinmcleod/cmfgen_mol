...
!
	INTEGER NOBS,NFIT
	REAL(10) OBS_SPEC(NOBS),OBS_NU(NOBS)
	REAL(10) FIT_SPEC(NFIT),FIT_NU(NFIT)
	REAL(10) R_MIN,R_MAX
!
	REAL(10) RHS(2)
	REAL(10) MAT(2,2)
!
	REAL(10), ALLOCATABLE :: NU_ST(:)
	REAL(10), ALLOCATABLE :: NU_END(:)
	REAL(10), ALLOCATABLE :: LAM_ST(:)
	REAL(10), ALLOCATABLE :: LAM_END(:)
	REAL(10), ALLOCATABLE :: OBS(:)
	REAL(10), ALLOCATABLE :: FIT(:)
	REAL(10), ALLOCATABLE :: WEIGHT(:)
	REAL(10), ALLOCATABLE :: GAL_RED_LAW(:)
	REAL(10), ALLOCATABLE :: GAL_RED_LAW_SAVE(:)
!
	INTEGER IOS
	INTEGER I,K,L
	INTEGER LST,LEND
