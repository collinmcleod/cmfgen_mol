...
!
	...
	REAL(10), ALLOCATABLE :: CONT_FLUX(:)
	REAL(10), ALLOCATABLE :: EW(:)
!
	REAL(10) CONT_LAM_B,CONT_LAM_R
	REAL(10) LINE_LAM_B,LINE_LAM_R
	REAL(10) LINE_WAVELENGTH
	REAL(10) LINE_FREQUENCY
!
	REAL(10) CONT_SLOPE
	REAL(10) CONT_FLUX_R
	REAL(10) CONT_FLUX_B
