...
!
	...
	REAL(10) REV_NU(MAX(NCF,N_LOC))
	REAL(10) REV_FLUX(MAX(NCF,N_LOC))
	REAL(10) RESP(MAX(NCF,N_LOC))
	REAL(10) TRANS(MAX(NCF,N_LOC))
...
!
	...
	REAL(10) FILT_LAM(NF_MAX)
	REAL(10) FILT_FREQ(NF_MAX)
	REAL(10) FILT_RESP(NF_MAX)
	REAL(10) ATM_LAM(NF_MAX)
	REAL(10) ATM_TRANS(NF_MAX)
	REAL(10) ATM_FREQ(NF_MAX)
!
	REAL(10) T1,T2
	REAL(10) MAG
	REAL(10) NORM
