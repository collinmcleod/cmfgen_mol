...
!
	INTEGER ND
	REAL(10) R(ND),V(ND),SIGMA(ND),ED(ND)
	REAL(10) T(ND)
	REAL(10) TGREY(ND),dE_RAD_DECAY(ND)
	REAL(10) POP_ATOM(ND),POP_ION(ND)
	REAL(10) MASS_DENSITY(ND),CLUMP_FAC(ND)
	REAL(10) ROSS_MEAN(ND),FLUX_MEAN(ND),PLANCK_MEAN(ND),ABS_MEAN(ND)
	REAL(10) J_INT(ND),H_INT(ND),K_INT(ND)
	CHARACTER(LEN=*) FORMAT_DATE
!
	INTEGER LUIN
!
