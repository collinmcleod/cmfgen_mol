	...
	END INTERFACE
C
	INTEGER*4, PARAMETER :: GT_IN=5
	INTEGER*4, PARAMETER :: GT_OUT=6
	INTEGER*4  LF_IN
	INTEGER*4  LF_OUT
	LOGICAL TERM_INPUT
	LOGICAL LOG_FILE
...
C
	...
	CHARACTER STR*(*)
C
	INTEGER*4 K,L,IOS,LEN_FORM,LEN_TOT
...
C
	...
	INTEGER*4, PARAMETER :: GT_OUT=6
C
	INTEGER*4 N,NMAX,VAL(NMAX)
	CHARACTER STR*(*)
C
	INTEGER*4 L,IOS,LEN_FORM,LEN_TOT
