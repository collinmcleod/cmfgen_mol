...
C
	INTEGER*4 LENGTH,I,J,POW,NUM_SIG_DIG
...
C 
C
C Routine to format DOUBLE precision numbers to their most compact form.
C Only NUM_SIG_DIG signicant digits are assumed. Routine calls
C
C                 FORM_SP_NUM
C
	...
	INTEGER*4 LENGTH
	VAL1=VAL
	CALL FORM_SP_NUM(VAL1,FORM,LENGTH)
	RETURN
	END
