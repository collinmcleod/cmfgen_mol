...
!
	...
	REAL(10), PARAMETER :: RYDBERG_HELIUM  =109722.3D0		!/cm
	REAL(10), PARAMETER :: RYDBERG_CARBON  =109732.3D0		!/cm
	REAL(10), PARAMETER :: RYDBERG_NITROGEN=109733.0D0		!/cm
	REAL(10), PARAMETER :: RYDBERG_OXYGEN  =109733.5D0		!/cm
!
	REAL(10), PARAMETER :: MASS_SUN=1.989D+33  			!gm
	REAL(10), PARAMETER :: RAD_SUN =6.9599D+10			!cm (changed 7-Jan-2008)
	REAL(10), PARAMETER :: LUM_SUN =3.826D+33				!erg/s
	REAL(10), PARAMETER :: TEFF_SUN=5770.0D0				!K
!
	REAL(10), PARAMETER :: ASTRONOMICAL_UNIT=1.49597892D+13		!cm
	REAL(10), PARAMETER :: PARSEC           =3.0856D+18       	!cm
	REAL(10), PARAMETER :: JANSKY           =1.0D-23			!ergs/cm^2/s/Hz
!
	REAL(10), PARAMETER ::           PI=3.141592653589793238462643D0
	REAL(10), PARAMETER ::       FUN_PI=3.141592653589793238462643D0
	REAL(10), PARAMETER :: SECS_IN_YEAR=31557600.0D0     		!365.25*24*60*60
!
