...
!
	REAL(10), ALLOCATABLE :: VTURB(:)
	REAL(10), ALLOCATABLE :: MAX_DEL_V_RES_ZONE(:)
!
...
! 
	INTEGER NLF
	REAL(10), ALLOCATABLE :: FREQ_CMF(:)
	REAL(10), ALLOCATABLE :: CHI_CMF(:,:)
	REAL(10), ALLOCATABLE :: ETA_CMF(:,:)
	REAL(10), ALLOCATABLE :: RAY_CMF(:,:)
	REAL(10), ALLOCATABLE :: NEW_RJ_CMF(:,:)
!
	REAL(10), ALLOCATABLE :: FREQ_RJ(:)
	REAL(10), ALLOCATABLE :: RJ_CMF(:,:)
	REAL(10), ALLOCATABLE :: RJ_VEC(:)
	REAL(10), ALLOCATABLE :: NEW_RJ_VEC(:)
!
	INTEGER NOS
	REAL(10), ALLOCATABLE :: OBS_FREQ(:)
	REAL(10), ALLOCATABLE :: OBS_FLUX(:)
! 
!
