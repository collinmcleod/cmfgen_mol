...
!
	DO ISPEC=1,NUM_SPECIES
	  ...
	  TMP_KEY='SCL_'//TRIM(SPECIES(ISPEC))//'_DMIN'
	  CALL RD_STORE_INT(ABUND_SCALE_DMIN(ISPEC),TMP_KEY,L_FALSE,'Lower depth limit for abundance scaling')
	  TMP_KEY='SCL_'//TRIM(SPECIES(ISPEC))//'_DMAX'
	  CALL RD_STORE_INT(ABUND_SCALE_DMAX(ISPEC),TMP_KEY,L_FALSE,'Upper depth limit for abundance scaling')
	END DO
!
